...
@interface APSM_Pages ()<UIAlertViewDelegate,TTScrollSlidingPagesControllerDelegate,TTSlidingPagesDataSource>
@property (weak, nonatomic) IBOutlet UIButton *buttonBack;
@property (weak, nonatomic) IBOutlet UIButton *buttonMenu;
@property (weak, nonatomic) IBOutlet UIButton *buttonNext;
@end

@implementation APSM_Pages
...
//    [self.view addSubview:w];
    ...
    UIImageView *imgLabel = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"page_buttombackground(1008x64).png"]];
